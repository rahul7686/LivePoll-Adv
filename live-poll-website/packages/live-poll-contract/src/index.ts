...
export const networks = {
  testnet: {
    ...
    contractId: "CC43GCB3LMRLKQ6JFJCPNT2QJXVOK73Y5HWAF7RZAYIMRL322I7WIZ6L",
  }
} as const
...
export interface Client {
   ...
   */
  vote: ({option}: {option: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAEdm90ZQAAAAEAAAAAAAAABm9wdGlvbgAAAAAAEQAAAAA=",
